...
import BuyAddressView from "../customer/components/buyAddressView";
import BuyAddressMobileView from "./buyAddressMobileView";

const CustomerInfoMobileView = () => {
	...
	return (
		<div className="rounded-bottom">
			<div className="cus-block-info rounded-3 pl-4 pr-4 pb-2">
				<div className="cus-prf">
					<div className="h-100">
						<div className="mt-2">
							<h6 className="bold titleH">Thông tin nhân khẩu học</h6>
							<div className="row row-cols-2 border-bottom pb-3">
								<div>
			...
			<BuyAddressMobileView />
		</div>
	)
}

export default memo(CustomerInfoMobileView) 